...
def generar_oleada(visible_sprites, enemy_sprites, obstaculos_sprites, player, numero_oleada, zombies_por_oleada, ANCHO, ALTURA):
    numero_oleada += 1
    ...
    for _ in range(cantidad_zombies):
        ...
        Zombie((x, y), [visible_sprites, enemy_sprites], obstaculos_sprites, player, "Zombie")
